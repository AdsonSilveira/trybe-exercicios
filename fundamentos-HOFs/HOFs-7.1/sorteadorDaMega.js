...
const checarNum = (meuNum, num) => meuNum === num;

const loteriaResultado = (meuNum, callback) => {
    const num = Math.floor((Math.random() * 5) + 1);
    return callback(meuNum, num) ? 'Parabéns, você ganhou' : 'Tente novamente!';
};

console.log(loteriaResultado(2, checarNum));
